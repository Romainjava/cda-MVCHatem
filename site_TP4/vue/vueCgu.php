...
<p>
    <span class="site">www.eltomate.com</span> est édité par la société <strong>Miam</strong>, propriété de Lionel Romain, Ewen Prigent, et Christophe Fontaine.
</p>
...
<p>L'utilisation du site <span class="site">www.eltomate.com</span> implique l'acceptation des conditions d'utilisations mentionnées ci-dessous.</p>

<p>Une fois connecté et participant au site, l'utilisateur reconnait avoir lu l'intégralité des conditions générales d'utilisations présentes dans la section <abbr title="conditions générales d'utilisation">CGU</abbr> du site. Les conditions sont disponibles à l'adresse suivante : <a href="http://www.eltomate.com/cgu">www.eltomate.com/cgu</a></p>

<p>La société Miam se réserve le droit de modifier à tout instant les présentes conditions générales. A chaque nouvelle version, les utilisateurs sont avertis par mail, et par un bandeau sur le site. Ainsi les utilisateurs peuvent et doivent se tenir à jour des modifications apportées.</p>

<p>En cas de manquement aux <abbr title="conditions générales d'utilisation">CGU</abbr> la société Miam se réserve le droit de suspendre ou supprimer un compte utilisateur.</p>

<h2 id="desc">Description du service</h2>
<p>Le site <span class="site">www.eltomate.com</span> permet de consulter les fiches des restaurants contenus dans sa base de données. Les restaurants sont décrits à l'aide de caractéristiques précises. Celles-ci permettent d'effectuer des recherches précises.
...
<p>Les restaurants ont la possibilité de <em>répondre</em> aux critiques reçues sur le site.
    De même les critiques sont relues par une équipe de modération interne à la société Miam. </p>
...
<p>
    Lors de la publication d'un avis l'utilisateur comprend qu'une modération sera effectuée <strong>avant</strong> que l'avis soit définitivement visible sur le site <span class="site">www.eltomate.com</span>.
</p>
Sont <strong>exclus</strong> du droit de publication d'avis : 
<ul>
    <li>les restaurateurs</li>
    <li>les employés de la société Miam</li>
</ul>
<p>
...
<p>
    Lors de l'inscription certaines données personnelles sont stockées dans le système d'information de Miam. Ces données sont enregistrées conformément au respect de la protection des données personnelles.
    Ces données sont utilisées pour permettre à l'utilisateur de profiter de toutes les fonctionnalités du site <span class="site">www.eltomate.com</span>
</p>
...
<p>
    Lors de l'inscription sur le site, les utilisateurs peuvent accepter ou refuser l'utilisation de leur adresse e-mail à des fins d'information (<em>newsletter</em>) pour le site <span class="site">www.eltomate.com</span> et d'autres sites de la société Miam.
</p>
<p>
    Le carnet d'adresse ainsi constitué par la société Miam peut éventuellement être vendu à des sociétés partenaires, puis utilisé à des fins commerciales pour du démarchage, et pour orienter l'utilisateur vers des produits répondant à ses préférences.
</p>
